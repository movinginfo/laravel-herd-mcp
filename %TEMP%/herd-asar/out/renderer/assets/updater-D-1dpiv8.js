import { d as defineComponent, a as ref, b as onMounted, j as computed, x as onUnmounted, o as openBlock, c as createElementBlock, e as createBaseVNode, t as toDisplayString, f as createCommentVNode, g as createVNode, w as withCtx, h as createTextVNode, q as createApp } from "./runtime-dom.esm-bundler-D2sOG0lg.js";
...
var markedExports = marked$1.exports;
const marked = /* @__PURE__ */ getDefaultExportFromCjs(markedExports);
...
const _hoisted_3 = { class: "h-full flex flex-col w-full bg-white dark:bg-gray-900" };
const _hoisted_4 = { class: "flex flex-col w-full h-full overflow-hidden items-center justify-center p-8 mb-8" };
const _hoisted_5 = /* @__PURE__ */ createBaseVNode("img", {
  src: _imports_0,
  class: "h-24"
}, null, -1);
const _hoisted_6 = { class: "w-full mt-6" };
const _hoisted_7 = { class: "text-center font-bold text-lg mb-2" };
const _hoisted_8 = {
  class: "overflow-y-auto h-full bg-gray-50 p-4 border dark:border-gray-600 dark:bg-gray-800",
...
const _hoisted_11 = { class: "border-t border-gray-200 dark:border-gray-600 px-6 py-3 bg-gray-50 dark:bg-gray-800 justify-end flex items-center space-x-4 min-h-[60px]" };
const _hoisted_12 = {
  key: 0,
  class: "flex-1 items-center space-x-2 w-full"
};
const _hoisted_13 = { class: "flex space-x-2 items-center" };
const _hoisted_14 = /* @__PURE__ */ createBaseVNode("span", { class: "" }, "Downloading update", -1);
const _hoisted_15 = ["value"];
const _hoisted_16 = {
  key: 1,
  class: "flex-1 items-center space-x-2 w-full"
};
const _hoisted_17 = { class: "flex space-x-2 items-center" };
const _hoisted_18 = /* @__PURE__ */ createBaseVNode("span", { class: "" }, "Preparing update - Herd will restart automatically.", -1);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    onMounted(async () => {
      ...
      changelogMarkdown.value = result.changelog;
      latestVersion.value = result.latestVersion;
      removeUpdateProgressListener = window.api.app.updateProgress((_, progress) => {
        downloadProgress.value = progress.progress?.percent;
        if (downloadProgress.value >= 100) {
          installing.value = false;
          downloaded.value = true;
          installInterval = setInterval(() => {
            installProgress.value += 3.333;
      ...
      removeUpdateDownloadedListener = window.api.app.onUpdateDownloaded(() => {
        installing.value = false;
        downloaded.value = true;
        installInterval = setInterval(() => {
          installProgress.value += 3.333;
    ...
    const changelog = computed(() => {
      return marked(changelogMarkdown.value, {
        sanitize: true
      });
    });
    const install = async () => {
      installing.value = true;
      await window.api.app.installUpdates();
      installing.value = false;
      downloaded.value = true;
    };
    onUnmounted(() => {
      if (removeUpdateProgressListener !== null) {
        removeUpdateProgressListener();
      }
      if (removeUpdateDownloadedListener !== null) {
        ...
        createBaseVNode("div", _hoisted_3, [
          createBaseVNode("div", _hoisted_4, [
            ...
            createBaseVNode("div", _hoisted_6, [
              createBaseVNode("h1", _hoisted_7, "Update to Laravel Herd " + toDisplayString(latestVersion.value), 1),
              createBaseVNode("div", _hoisted_8, [
                changelog.value ? (openBlock(), createElementBlock("div", _hoisted_9, [
                  createBaseVNode("div", {
                    id: "changelogScreen",
                    class: "text-left prose dark:prose-invert",
                    ref: "content",
                    innerHTML: changelog.value
                  }, null, 8, _hoisted_10)
          ...
          createBaseVNode("div", _hoisted_11, [
            installing.value ? (openBlock(), createElementBlock("div", _hoisted_12, [
            ...
            downloaded.value ? (openBlock(), createElementBlock("div", _hoisted_16, [
            ...
            createVNode(LightButton, {
              onClick: install,
              disabled: installing.value || downloaded.value,
